...
export const metadata = {
    ...
    openGraph: {
        title: "American grocery store Paid Media Services & Expert Online Advertising Solutions",
        description: "Discover top-tier American grocery store paid media services from our expert programmatic advertising agency. Maximize your brand's reach and ROI with our targeted solutions.",
        url: "https://www.nspglobalservices.com/ppc-services-for/american-grocery-store",
    },
    alternates: {
        canonical: "https://www.nspglobalservices.com/ppc-services-for/american-grocery-store",
    },
};
function page() {
    return (
        <>
            <Head>
                ...
                <link rel="canonical" href={`https://www.nspglobalservices.com/ppc-services-for/american-grocery-store`} />
            </Head>
