...
export default function AlcoholPPCPage() {
  const [openFaq, setOpenFaq] = useState(null)

  const features = [
    { title: "Alcohol‑compliant setup", description: "Geo targeting, age gating and policy‑safe creatives across networks." },
    { title: "High‑intent queries", description: "Query sculpting, negatives and match types to focus budget on buyers." },
    { title: "Landing page CRO", description: "Fast, persuasive pages for tastings, tours and DTC orders." },
    { title: "Accurate tracking", description: "Server‑side events, enhanced conversions and ROAS dashboards." },
    { title: "Creative testing", description: "Iterative copy, headline and visual tests to lift CTR and lower CPC." },
    { title: "Clear reporting", description: "Weekly snapshots and monthly strategy reviews." },
  ]

  const pricing = {
    Starter: { price: "$999/mo", features: ["Account setup/cleanup", "Keyword + negatives", "1 landing page", "Basic tracking", "Weekly snapshots"] },
    Growth: { price: "$1,999/mo", features: ["Search + PMax", "A/B ads + LP tests", "Advanced tracking", "E‑commerce where allowed", "Monthly strategy"], highlight: true },
    Scale: { price: "Custom", features: ["Multi‑location", "Custom dashboards", "Audience research + creatives", "Dedicated strategist", "Priority support"] },
  }

  const portfolio = [
    { title: "Highland Whiskey Co.", category: "Lead Gen + Orders", image: "https://res.cloudinary.com/dyzdnyq0d/image/upload/v1761856006/Gemini_Generated_Image_z3k07qz3k07qz3k0_idem2h.png" },
    { title: "Vineyard Estate", category: "Tour Bookings", image: "https://res.cloudinary.com/dyzdnyq0d/image/upload/v1761856006/Gemini_Generated_Image_nswtcnswtcnswtcn_tujcvc.png" },
    { title: "Craft Brewery", category: "Taproom Awareness", image: "https://res.cloudinary.com/dyzdnyq0d/image/upload/v1761854812/Gemini_Generated_Image_3vdfho3vdfho3vdf_wqpovr.png" },
  ]
      ...
      <section suppressHydrationWarning className="relative min-h-[70vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-amber-950 via-stone-950 to-yellow-950">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-block text-amber-300 text-xs md:text-sm font-semibold uppercase tracking-[0.2em] mb-5 bg-amber-950/30 px-5 py-2 rounded-full border border-amber-500/30">Alcohol PPC Management</span>
            <h1 className="text-4xl md:text-6xl font-extrabold text-amber-50 mb-5 leading-tight">Profitable, compliant PPC for premium spirits</h1>
            <p className="text-lg md:text-xl text-amber-100 mb-8">Turn intent into revenue with campaigns built for regulation and speed.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/contact" className="inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold px-7 py-4 rounded-xl hover:from-amber-700 hover:to-orange-700 transition-transform duration-300 hover:scale-[1.03] border border-amber-400">Get PPC Proposal</a>
              <a href="#portfolio" className="inline-flex items-center justify-center border border-amber-400 text-amber-50 font-bold px-7 py-4 rounded-xl hover:bg-amber-600/20 transition-transform duration-300 hover:scale-[1.03]">See Results</a>
            </div>
          </div>
        </div>
      </section>
  ...
  return (
    <div className={`rounded-xl p-7 border transition-all duration-300 ${highlighted ? "bg-gradient-to-br from-amber-800/80 to-orange-800/70 border-amber-500 ring-2 ring-amber-400 shadow-xl" : "bg-stone-900/60 border-amber-600/50 shadow-md hover:shadow-lg"}`}>
      ...
      <div className="mb-5">
        ...
        {String(price).endsWith('/mo') && <span className="text-amber-100/80 ml-2 font-semibold">monthly</span>}
      </div>
