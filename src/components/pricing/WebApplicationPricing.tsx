      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-3">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Basic App</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-blue-600 relative">
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Professional App</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Enterprise App</h3>
              <div className="text-4xl font-bold text-blue-600 mb-2">$15,999</div>
              <div className="text-gray-600 mb-6">one-time</div>
              <ul className="text-left space-y-3 mb-8">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
