      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-xl text-gray-600">
            Build your online store with our comprehensive packages
          </p>
        </div>
        <div className="mt-12 grid gap-8 lg:grid-cols-3">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Basic Store</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-blue-600 relative">
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Advanced Store</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Enterprise Store</h3>
